...
private const val FLUTTER_ENGINE_NAME1 = "nps_12_name1"
...
class MainActivity : AppCompatActivity() {
	...
	override fun onCreate(savedInstanceState: Bundle?) {
		...
		binding.iconRate.setOnClickListener {
			startActivity(
				FlutterActivity.withCachedEngine(FLUTTER_ENGINE_NAME1)
...
//        }
	...
	private fun runFlutterNPS(routeKey: String = "") {
		startActivity(
